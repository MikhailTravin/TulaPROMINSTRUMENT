(() => {
    ...
    function indents() {
        ...
        let arrowPrev = document.querySelector(".main-home__arrow-prev");
        let arrowNext = document.querySelector(".main-home__arrow-next");
        let mainHomeBody = document.querySelector(".main-home__body");
        ...
        const sumMainHome = (wMainHome - wMainHomeBody) / 2;
